...
#Y_predfinal for the model with the highest accuracy, we notice that SVM has a better accuracy on the test model, hence we chose SVM method. 
Y_predfinal = svc.predict(X_test)
...
FINAL.to_csv('Prediction_Titanic_30SVM.csv',sep=',',index=False)
